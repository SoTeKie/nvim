...
vim.keymap.set({ 'n', 'i', 'v' }, '<C-Right>', '<C-w>l')
vim.keymap.set('n', '<C-h>', '<C-w><C-h>')
vim.keymap.set('n', '<C-l>', '<C-w><C-l>')
vim.keymap.set('n', '<C-j>', '<C-w><C-j>')
vim.keymap.set('n', '<C-k>', '<C-w><C-k>')

vim.keymap.set({ 'n', 'i', 'v' }, '<C-S-Left>', '10<C-w>>')
vim.keymap.set({ 'n', 'i', 'v' }, '<C-S-Down>', '10<C-w>-')
vim.keymap.set({ 'n', 'i', 'v' }, '<C-S-Up>', '10<C-w>+')
vim.keymap.set({ 'n', 'i', 'v' }, '<C-S-Right>', '10<C-w><')
